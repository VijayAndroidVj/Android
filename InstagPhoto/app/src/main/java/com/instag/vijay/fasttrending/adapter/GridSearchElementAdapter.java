...
public class GridSearchElementAdapter extends BaseAdapter {
...
//    String[] colors = new String[]{"#E91E63", "#4CAF50", "#9C27B0", "#F44336", "#3F51B5", "#2196F3", "#673AB7", "#00BCD4", "#009688", "#03A9F4", "#4CAF50", "#733f55", "#FFC107", "#4CAF50"};
    ...
    public GridSearchElementAdapter(Activity context, List<CategoryMain> categoryMainArrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflater.inflate(R.layout.category_search_main_item, null);
        }
...
//        CardView cv_category = gridView.findViewById(R.id.cv_category);
        ...
        // cv_category.setCardBackgroundColor(Color.parseColor("#ffffff"));
