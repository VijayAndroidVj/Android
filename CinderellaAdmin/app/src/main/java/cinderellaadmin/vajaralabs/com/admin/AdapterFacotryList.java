 ...
 */
public class AdapterFacotryList extends BaseAdapter {
    ...
    public AdapterFacotryList(Context context, ArrayList<HashMap<String, String>> hashMapArrayList) {
...
//
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.factory_list_update, viewGroup, false);
        ...
        mViewHolder.txt_shop_name.setText(hashMapArrayList.get(posistion).get("factory_name"));
        mViewHolder.txt_shopkeeper.setText(hashMapArrayList.get(posistion).get("contact_person"));
