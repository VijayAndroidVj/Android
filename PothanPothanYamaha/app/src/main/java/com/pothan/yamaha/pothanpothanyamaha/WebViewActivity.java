            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    webView.loadUrl("javascript:(function() { " +
                            "document.getElementsByClassName('top-header hidden-xs hidden-sm')[0].style.display='none'; })()");
                    // hide element by id
                    webView.loadUrl("javascript:(function() { " +
                            "document.getElementsByClassName('navbar yamm navbar-default navbar-static-top')[0].style.display='none';})()");
