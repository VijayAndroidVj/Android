...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public ColumnHeaderViewHolder(View itemView, ITableView pTableView) {
        ...
        arrow_up = ContextCompat.getDrawable(itemView.getContext(), R.drawable.ic_group_expand_01);
        arrow_down = ContextCompat.getDrawable(itemView.getContext(), R.drawable.ic_group_collapse_01);
        // Change its colors
