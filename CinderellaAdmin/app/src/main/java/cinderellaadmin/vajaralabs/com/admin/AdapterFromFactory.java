 ...
 */
public class AdapterFromFactory extends BaseAdapter {
    ...
    public AdapterFromFactory(Context context, ArrayList<HashMap<String, String>> hashMapArrayList) {
...
//
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.delivery_list, viewGroup, false);
        ...
        mViewHolder.txt_assign_factory.setText("Delivery");
        ...
        mViewHolder.txt_assign_factory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Configg.getDATA(context, "type").equals("shop")) {
                    ...
                    Intent intent = new Intent(context, AssignDealerDelivery.class);
