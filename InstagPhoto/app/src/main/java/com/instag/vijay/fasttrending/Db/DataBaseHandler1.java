...
//
//    private static DataBaseHandler1 dataBaseHandler;
//
//    //tbl_chatmessages
...
//
//
//    public static DataBaseHandler1 getInstance(Context context) {
//        if (dataBaseHandler == null) {
//            dataBaseHandler = new DataBaseHandler1(context);
//        }
...
//        db.delete(TBLFILTEREDCONTACTS, null, null);
//        db.delete(TROVACONTACTDISPLAYCALLLOGS, null, null);
//        db.delete(TROVAMISSEDCALLLOGS, null, null);
//        db.close();
//    }
//
