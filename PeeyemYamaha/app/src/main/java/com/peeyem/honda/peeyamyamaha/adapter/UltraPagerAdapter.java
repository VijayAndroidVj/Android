package com.peeyem.honda.peeyamyamaha.adapter;
...
import com.peeyem.honda.peeyamyamaha.MainActivity;
...
public class UltraPagerAdapter extends PagerAdapter {
    ...
    public String[] colors = new String[]{"#E91E63", "#9C27B0", "#F44336", "#3F51B5", "#2196F3", "#00BCD4", "#009688", "#03A9F4", "#4CAF50"};
