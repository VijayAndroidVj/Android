package com.instag.vijay.fasttrending.view;

import android.net.Uri;
import android.support.annotation.DrawableRes;

import com.instag.vijay.fasttrending.MyApplicaton;
...
public class CropGallery {
    ...
    public static List<Uri> getCroppedImageUris() {
        ...
        File saved = MyApplicaton.getInstance().getFilesDir();
    ...
    private static Uri resToUri(@DrawableRes int res) {
        return Uri.parse(String.format(
                ...
                MyApplicaton.getInstance().getPackageName(),
                res));
    }

    public static Uri createNewEmptyFile() {
        return Uri.fromFile(new File(
                MyApplicaton.getInstance().getFilesDir(),
