...
public class AssignDealer extends AppCompatActivity implements Response {

    private AssignDealer activity;
    private ArrayList<HashMap<String, String>> hashMapArrayList = new ArrayList<HashMap<String, String>>();
    private AdapterAssignDelivery adapterAssignDelivery;
    ...
    public void processFinish(String output) {
        ...
        try {
            ...
            adapterAssignDelivery = new AdapterAssignDelivery(activity, hashMapArrayList);
            list_delivery_person.setAdapter(adapterAssignDelivery);
