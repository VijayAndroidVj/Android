 ...
 */
public class ResideMenu1 extends FrameLayout implements View.OnClickListener {
    ...
    SharedPreferences lilyAppPreference;
    // jithin //
    private LinearLayout menuAddress;
    private LinearLayout menuOrder;
    private LinearLayout menuCart;
    private LinearLayout menuRepeatPurchase;
    private LinearLayout menuCashBack;
    private LinearLayout menuFavorite;
    private LinearLayout menuNotfication;
    private LinearLayout menuHelp;
    private LinearLayout menuEarn;
    private LinearLayout menuCallus;
    private LinearLayout menuRateus;
    private LinearLayout menuShare;
    private LinearLayout menuAboutlily, menuTermsAndCondition, menuPrivacyPolicy;
    private LinearLayout menuLogout;
    private LinearLayout menuLogin;
    private TextView img_lily_menu_user_location;
    ImageView img_lily_menu_list_logo;
    Context context;
    ImageView img_lily_menu_user_location_edit;
    boolean isLoggedOut = false;
    int imageResrouceOrginal = 0;

    public ResideMenu1(Context context) {
        super(context);
    ...
    private void initViews(Context context) {
        ...
        img_lily_menu_user_location = (TextView) findViewById(R.id.img_lily_menu_user_location);
        menuAddress = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_address);
        menuOrder = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_order);
        menuCart = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_cart);
        menuRepeatPurchase = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_repeat_purchase);
        menuCashBack = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_cashback);
        menuFavorite = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_favorite);
        menuNotfication = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_notification);
        menuHelp = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_help);
        menuEarn = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_earn);
        menuCallus = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_callus);
        menuRateus = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_rateus);
        menuShare = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_share);
        menuAboutlily = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_aboutlily);
        menuTermsAndCondition = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_terms_and_condition);
        menuPrivacyPolicy = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_privacy_policy);
        menuLogout = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_logout);
        menuLogin = (LinearLayout) findViewById(R.id.lyt_lily_muenuList_login);
        img_lily_menu_user_location_edit = (ImageView) findViewById(R.id.img_lily_menu_user_location_edit);
        img_lily_menu_list_logo = (ImageView) findViewById(R.id.img_lily_menu_list_logo);
        menuAddress.setOnClickListener(this);
        menuOrder.setOnClickListener(this);
        menuCart.setOnClickListener(this);
        menuRepeatPurchase.setOnClickListener(this);
        menuCashBack.setOnClickListener(this);
        menuFavorite.setOnClickListener(this);
        menuNotfication.setOnClickListener(this);
        menuHelp.setOnClickListener(this);
        menuEarn.setOnClickListener(this);
        menuCallus.setOnClickListener(this);
        menuRateus.setOnClickListener(this);
        menuShare.setOnClickListener(this);
        menuAboutlily.setOnClickListener(this);
        menuTermsAndCondition.setOnClickListener(this);
        menuPrivacyPolicy.setOnClickListener(this);
        menuLogout.setOnClickListener(this);
        menuLogin.setOnClickListener(this);
        img_lily_menu_user_location_edit.setOnClickListener(this);
        img_lily_menu_list_logo.setOnClickListener(this);
        ...
        imageViewBackground.setBackgroundDrawable(null);
    ...
    public void setBackground(int imageResrouce) {
        imageResrouceOrginal = imageResrouce;
...
//                R.drawable.shadow));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.lyt_lily_muenuList_address:


                Intent in = new Intent(context, AddMedicine.class);
