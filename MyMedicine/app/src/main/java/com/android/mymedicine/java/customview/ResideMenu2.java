...
import com.android.mymedicine.java.activity.Settings;
 ...
 */
public class ResideMenu2 extends FrameLayout implements View.OnClickListener {
    ...
    public ResideMenu2(Context context) {
        super(context);
    ...
    private void initViews(Context context) {
        ...
        inflater.inflate(R.layout.mymedicine_residemenu, this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_residemmenu_logout:
                ...
                case R.id.ll_residemmenu_notification:
                Intent settingsActivity = new Intent(context, Settings.class);
